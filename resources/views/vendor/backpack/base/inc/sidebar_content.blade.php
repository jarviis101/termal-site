...
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon las la-sitemap"></i> Главная</a>
...
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#"><i class="nav-icon las la-exclamation"></i> Проекты</a>
    <ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('type') }}'><i class='nav-icon las la-code-branch'></i> Отрасль</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('project') }}'><i class='nav-icon las la-copyright'></i> Проекты</a></li>
    </ul>
</li>
